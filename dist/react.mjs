...
function ThemeSwatch({ theme, selected, onClick }) {
  ...
  return /* @__PURE__ */ jsxs2(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsx2("span", { style: { width: 12, height: 12, borderRadius: "50%", background: bg, border: "1px solid rgba(0,0,0,0.1)", display: "inline-block" } }),
        ...
        /* @__PURE__ */ jsx2("span", { style: { marginLeft: 4, fontSize: 12 }, children: theme.label })
      ]
    }
  );
}
function ThemePicker({
  ...
  const [customNeutral, setCustomNeutral] = useState2("slate");
  ...
  return /* @__PURE__ */ jsxs2("div", { className, style: containerStyle, children: [
    allowCustom && /* @__PURE__ */ jsxs2("div", { style: tabBarStyle, children: [
      /* @__PURE__ */ jsx2("button", { style: tabBtnStyle(tab === "presets"), onClick: () => setTab("presets"), children: "Presets" }),
      /* @__PURE__ */ jsx2("button", { style: tabBtnStyle(tab === "custom"), onClick: () => setTab("custom"), children: "Custom" })
    ] }),
    tab === "presets" && /* @__PURE__ */ jsx2("div", { children: /* @__PURE__ */ jsx2("div", { style: { display: "flex", flexWrap: "wrap", gap: 2 }, children: themes.map((t) => /* @__PURE__ */ jsx2(
      ThemeSwatch,
      {
        theme: t,
    ...
    tab === "custom" && allowCustom && /* @__PURE__ */ jsxs2("div", { style: { display: "flex", flexDirection: "column", gap: 16 }, children: [
      sections.includes("colors") && /* @__PURE__ */ jsxs2("section", { children: [
        ...
        /* @__PURE__ */ jsx2("div", { style: { display: "flex", flexWrap: "wrap", gap: 6 }, children: TAILWIND_COLORS2.map((color) => /* @__PURE__ */ jsx2(
          "button",
          {
        ...
        /* @__PURE__ */ jsx2("div", { style: { display: "flex", flexWrap: "wrap", gap: 6 }, children: NEUTRAL_COLORS.map((color) => /* @__PURE__ */ jsx2(
          "button",
          {
      ...
      sections.includes("fonts") && /* @__PURE__ */ jsxs2("section", { children: [
        ...
        /* @__PURE__ */ jsx2("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: ["sans", "serif", "mono"].map((fontType) => /* @__PURE__ */ jsxs2("label", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
          /* @__PURE__ */ jsx2("span", { style: { width: 40, fontSize: 12, opacity: 0.7 }, children: fontType }),
          /* @__PURE__ */ jsxs2(
            "select",
            {
      ...
      sections.includes("patterns") && /* @__PURE__ */ jsxs2("section", { children: [
        ...
        /* @__PURE__ */ jsx2("div", { style: { display: "flex", flexWrap: "wrap", gap: 6 }, children: PATTERN_TYPES.map((pt) => /* @__PURE__ */ jsx2(
          "button",
          {
      ...
      sections.includes("radius") && /* @__PURE__ */ jsxs2("section", { children: [
        ...
        /* @__PURE__ */ jsx2("div", { style: { display: "flex", gap: 6 }, children: RADIUS_PRESETS.map((r) => /* @__PURE__ */ jsx2(
          "button",
          {
